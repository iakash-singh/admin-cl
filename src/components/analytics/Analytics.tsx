        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              {/* Conversion, Abandonment, Retention */}
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    value: users.cartAbandonmentRate,
                    color: "bg-red-500",
                    text: "text-red-600",
                  },
                  {
                  ...
                  <div key={metric.label}>
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`text-sm font-medium ${metric.text}`}>
                        {metric.value}%
                      </span>
                    </div>
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {vendors.pendingApproval} pending
                  </p>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-yellow-600 mt-1">
                    ${vendors.averageRevenue.toLocaleString()}
                  </p>
              ...
              {[
                {
                  ...
                  value: vendors.onboardingDropoff,
                  color: "bg-red-500",
                  text: "text-red-600",
                },
                {
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-yellow-600">
                        {(
                          (product.totalRentals / product.wishlistCount) *
                          100
                        ).toFixed(1)}
                        % conversion
                      </p>
                ...
                {products.leastPerformingProducts.map((product) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">
                        Last rented:{" "}
                        {new Date(product.lastRented).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs font-medium text-gray-900">
                ...
                {mockLocations.slice(0, 5).map((location) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">
                        {(
                          location.userCount / location.vendorCount
                        ).toFixed(1)}{" "}
                        users/vendor
                      </p>
