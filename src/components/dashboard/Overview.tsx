...
export default function Overview() {
  ...
  // Safe background color map (avoids dynamic Tailwind issues)
          ...
          {[
            {
              ...
              detail: "Party Equipment Central submitted documents",
              color: "blue",
              time: "2 hours ago",
            },
            {
              title: "Order completed",
              detail: "Professional Camera Kit rental finished",
              color: "green",
              time: "4 hours ago",
            },
            {
              title: "Payment pending",
              detail: "DJ Sound System order awaiting payment",
              color: "amber",
              time: "6 hours ago",
            },
          ].map((activity, idx) => {
